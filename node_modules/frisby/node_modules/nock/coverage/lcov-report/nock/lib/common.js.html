...
<html lang="en">
<head>
    <title>Code coverage report for nock/lib/common.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">nock/lib/common.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.85% <small>(92 / 97)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">82.26% <small>(51 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(16 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.79% <small>(91 / 95)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">nock/lib/</a> &#187; common.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">761</span>
<span class="cline-any cline-yes">761</span>
<span class="cline-any cline-yes">749</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">761</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">54599540</span>
...
&nbsp;
    for(var i = 0; i &lt; lhs.length; ++i) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if(lhs[i] !== rhs[i]) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (body &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof(body) !== 'string')</span> {
<span class="cstat-no" title="statement not covered" >    body = body.toString();</span>
  }
&nbsp;
  var port = options.port;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (! port) <span class="cstat-no" title="statement not covered" >port = (options.proto == 'https' ? '443' : '80');</span>
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if(!_.isObject(headers) || !_.isString(fieldNameToDelete)) {
