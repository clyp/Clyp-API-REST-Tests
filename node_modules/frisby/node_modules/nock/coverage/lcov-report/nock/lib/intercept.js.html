...
<html lang="en">
<head>
    <title>Code coverage report for nock/lib/intercept.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">nock/lib/intercept.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.6% <small>(174 / 182)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">86.52% <small>(77 / 89)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.15% <small>(25 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.56% <small>(172 / 180)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">nock/lib/</a> &#187; intercept.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">348</span>
<span class="cline-any cline-yes">348</span>
<span class="cline-any cline-yes">3660</span>
...
<span class="cline-any cline-yes">172</span>
<span class="cline-any cline-yes">172</span>
<span class="cline-any cline-yes">10320</span>
<span class="cline-any cline-yes">5160</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
&nbsp;
  return allInterceptors[basePath] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
}
&nbsp;
function removeInterceptor(options) {
  var baseUrl, key, method, proto;
&nbsp;
  proto = options.proto ? <span class="branch-0 cbranch-no" title="branch not covered" >options.proto </span>: 'http';
&nbsp;
  common.normalizeRequestOptions(options);
  baseUrl = proto + '://' + options.host;
&nbsp;
  if (allInterceptors[baseUrl] &amp;&amp; allInterceptors[baseUrl].length &gt; 0) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.path) {
      method = options.method &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.method.toUpperCase() </span>|| 'GET';
      key = method + ' ' + baseUrl + (options.path || <span class="branch-1 cbranch-no" title="branch not covered" >'/')</span>;
&nbsp;
      for (var i = 0; i &lt; allInterceptors[baseUrl].length; i++) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (allInterceptors[baseUrl][i]._key === key) {
          allInterceptors[baseUrl].splice(i, 1);
          break;
        }
      }
    } else {
<span class="cstat-no" title="statement not covered" >      allInterceptors[baseUrl].length = 0;</span>
    }
&nbsp;
    return true;
  }
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if(originalClientRequest) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Nock already overrode http.ClientRequest');</span>
  }
&nbsp;
...
&nbsp;
  ...
  function OverriddenClientRequest(options, cb) {
    http.OutgoingMessage.call(this);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (isOn() &amp;&amp; hasHadInterceptors(options)) {
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      debug('falling back to original ClientRequest');</span>
&nbsp;
      //  Fallback to original ClientRequest if nock is off or the net connection is enabled.
<span class="cstat-no" title="statement not covered" >      if(isOff() || isEnabledForNetConnect(options)) {</span>
<span class="cstat-no" title="statement not covered" >        originalClientRequest.apply(this, arguments);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        timers.setImmediate(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          var error = new NetConnectNotAllowedError(options.host, options.path);</span>
