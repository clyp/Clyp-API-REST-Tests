...
<html lang="en">
<head>
    <title>Code coverage report for nock/lib/scope.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">nock/lib/scope.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.13% <small>(271 / 291)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">82.18% <small>(143 / 174)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">89.29% <small>(50 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">93.08% <small>(269 / 289)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">nock/lib/</a> &#187; scope.js</div>
</div>
<div class="body">
...
683
684
685</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  function remove(key, interceptor) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (persist) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    var arr = interceptors[key];
    <span class="missing-if-branch" title="else path not taken" >E</span>if (arr) {
...
&nbsp;
      //  We use lower-case headers throught Nock.
      headers = common.headersFieldNamesToLowerCase(headers);
&nbsp;
      this.options = interceptorOptions || {};
      for(var opt in scopeOptions) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if(typeof this.options[opt] === 'undefined') {
          this.options[opt] = scopeOptions[opt];
        }
      }
&nbsp;
      if (scope._defaultReplyHeaders) {
        headers = headers || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
&nbsp;
        ...
        for (var key2 in headers) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (headers.hasOwnProperty(key2)) {
...
<span class="cstat-no" title="statement not covered" >            throw new Error('Error encoding response body into JSON');</span>
          }
        }
      }
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof(body) !== 'string') {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(key === 'host' &amp;&amp;
          (<span class="branch-1 cbranch-no" title="branch not covered" >_.isUndefined(options.headers[key]) </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >           _.isUndefined(this.reqheaders[key]))</span>)
        {
...
&nbsp;
      ...
      if(this.__nock_filteredScope) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (
             ...
             (<span class="branch-2 cbranch-no" title="branch not covered" >options.port !== 80 </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >options.proto !== 'http')</span> &amp;&amp;
             (<span class="branch-4 cbranch-no" title="branch not covered" >options.port !== 443 </span>|| <span class="branch-5 cbranch-no" title="branch not covered" >options.proto !== 'https')</span>
           ) {
<span class="cstat-no" title="statement not covered" >          matchKey += ":" + options.port;</span>
        }
      }
      matchKey += path;
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function filteringPath() {</span>
<span class="cstat-no" title="statement not covered" >      if (typeof arguments[0] === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        this.transformFunction = arguments[0];</span>
      }
...
&nbsp;
    ...
    */
    function times(newCounter) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (newCounter &lt; 1) {
<span class="cstat-no" title="statement not covered" >        return this;</span>
      }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function patch(uri, requestBody, options) {</span>
<span class="cstat-no" title="statement not covered" >    return intercept(uri, 'PATCH', requestBody, options);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function merge(uri, requestBody, options) {</span>
<span class="cstat-no" title="statement not covered" >    return intercept(uri, 'MERGE', requestBody, options);</span>
  }
&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof (arguments[0]) === 'function') {
      return arguments[0];
    }
  }
&nbsp;
  function filteringPath() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!transformPathFunction) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid arguments: filtering path should be a function or a regular expression');</span>
    }
    return this;
  }
&nbsp;
  function filteringRequestBody() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!transformRequestBodyFunction) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid arguments: filtering request body should be a function or a regular expression');</span>
    }
    return this;
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function log(newLogger) {</span>
<span class="cstat-no" title="statement not covered" >    logger = newLogger;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  }
&nbsp;
  function _persist() {
...
&nbsp;
  function replyDate(d) {
    date = d || <span class="branch-1 cbranch-no" title="branch not covered" >new Date();</span>
    return this;
  }
&nbsp;
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function load(path) {</span>
<span class="cstat-no" title="statement not covered" >  return define(loadDefs(path));</span>
}
&nbsp;
function getStatusFromDefinition(nockDef) {
  ...
  if(!_.isUndefined(nockDef.reply)) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if(_.isNumber(parsedReply)) {
      return parsedReply;
    }
  }
&nbsp;
  var DEFAULT_STATUS_OK = 200;
  return nockDef.status || <span class="branch-1 cbranch-no" title="branch not covered" >DEFAULT_STATUS_OK;</span>
}
&nbsp;
...
&nbsp;
  ...
  if(!_.isUndefined(nockDef.port)) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if(_.isNull(options.port)) {
      return nockDef.scope + ':' + nockDef.port;
    } else {
<span class="cstat-no" title="statement not covered" >      if(parseInt(options.port) !== parseInt(nockDef.port)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Mismatched port numbers in scope and port properties of nock definition.');</span>
      }
    }
  }
&nbsp;
...
&nbsp;
    var nscope     = getScopeFromDefinition(nockDef)
      , npath      = nockDef.path
      , method     = nockDef.method.toLowerCase() || <span class="branch-1 cbranch-no" title="branch not covered" >"get"</span>
...
&nbsp;
    ...
    options = _.clone(options) || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
<span class="cstat-no" title="statement not covered" >      nock = startScope(nscope, options).filteringRequestBody(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >        return "*";</span>
      })[method](npath, "*").reply(status, response, headers);
    } else {
      nock = startScope(nscope, options);
      //  If request headers were specified filter by them.
      <span class="missing-if-branch" title="else path not taken" >E</span>if(reqheaders !== {}) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Mar 30 2015 18:25:09 GMT+0100 (WEST)</div>
</div>
