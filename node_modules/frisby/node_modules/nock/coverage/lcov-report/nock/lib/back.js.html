...
<html lang="en">
<head>
    <title>Code coverage report for nock/lib/back.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">nock/lib/back.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">nock/lib/</a> &#187; back.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    throw new Error ('processing hooks must be a function');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  scopes.forEach(fn);</span>
}
&nbsp;
&nbsp;
&nbsp;
...
Back.setMode = function(mode) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if( !Modes.hasOwnProperty(mode) ) {
<span class="cstat-no" title="statement not covered" >    throw new Error ('some usage error');</span>
  }
&nbsp;
