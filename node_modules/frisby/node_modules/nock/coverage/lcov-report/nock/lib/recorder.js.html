...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">94.86% <small>(166 / 175)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">80.28% <small>(57 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">90.48% <small>(19 / 21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">94.86% <small>(166 / 175)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  if(common.isContentEncoded(headers)) {
    return _.map(chunks, function(chunk) {
      if(!Buffer.isBuffer(chunk)) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof chunk === 'string') {
...
&nbsp;
  ...
  ret.push(")\n");
  <span class="missing-if-branch" title="if path not taken" >I</span>if (req.headers) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (res.headers) {
    ret.push(', ');
...
&nbsp;
        ...
        _.each(res.listeners('data'), <span class="fstat-no" title="function not covered" >function(listener) {</span>
<span class="cstat-no" title="statement not covered" >          res.removeListener('data', listener);</span>
        })
        _.each(res.listeners('readable'), <span class="fstat-no" title="function not covered" >function(listener) {</span>
...
&nbsp;
    ...
    req.write = function(data) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if ('undefined' !== typeof(data)) {
